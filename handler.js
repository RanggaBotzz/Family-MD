...
module.exports = {
    async handler(chatUpdate) {
        ...
        //global.author = 'Rangga Botz'
        global.wm2 = global.data.namabot + ' ' + global.data.owner
        global.wm = namabot + ' ву Rangga Botz'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ʙy ᴀɢᴜᴢ ꜰᴀᴍɪʟɪᴀ'
        global.kontak2 = [
        ['6281320170984', '𝘼𝙜𝙪𝙯 𝙁𝙖𝙢𝙞𝙡𝙞𝙖', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'FokusDotId13@gmail.com', true],
        ['6285779150501', await this.getName('6285779150501@s.whatsapp.net'), 'ᴄꜱ ꜰᴀᴍɪʟy-ʙᴏᴛ', 'sa0066588@gmail.com', true],
